...
a("""<div id="date_selector"style="white-space: nowrap;
        overflow-x: auto;">      
                    <input type="text" id="config-demo" class="form-control"style="display: inline-block;width:35%"><button onclick="updateConfigAsObject()"style="display: inline-block;">Reset</button>
                  </center></div>
      </div>""")
...
html_bytes = bytes(a)
file=open('/home/Bsens/jbkb-master/apps/templates/home/index_'+str(listing)+'.html','w')

file.write(html)
file.close
file=open('/home/Bsens/jbkb-master/staticfiles/assets/js/index_'+str(listing)+'.js','w')
