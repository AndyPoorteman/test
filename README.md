# [Star Admin Django](https://appseed.us/admin-dashboards/django-star-admin)

Open-source **[Django Dashboard](https://appseed.us/admin-dashboards/django)** generated by AppSeed on top of an iconic design. **[Star Admin](https://appseed.us/admin-dashboards/django-star-admin)** is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed. **[Star Admin](https://appseed.us/admin-dashboards/django-star-admin)** has an impressive typography that compliments exceedingly with its colorful and elegant interface. 
